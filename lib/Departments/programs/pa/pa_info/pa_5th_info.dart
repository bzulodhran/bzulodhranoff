import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20Outline/eng_OUTLINE_SEMESTER_WISE/pa_5th.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20fee/pa_fee.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa_timetable_SEMESTER_WISE/pa_5th_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class pa_5th_info extends StatefulWidget {
  const pa_5th_info({Key? key}) : super(key: key);

  @override
  _pa_5th_infoState createState() => _pa_5th_infoState();
}

class _pa_5th_infoState extends State<pa_5th_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_5th()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_5th_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
