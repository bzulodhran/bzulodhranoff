import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20Outline/eng_OUTLINE_SEMESTER_WISE/pa_2nd.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20fee/pa_fee.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa_timetable_SEMESTER_WISE/pa_2nd_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class pa_2nd_info extends StatefulWidget {
  const pa_2nd_info({Key? key}) : super(key: key);

  @override
  _pa_2nd_infoState createState() => _pa_2nd_infoState();
}

class _pa_2nd_infoState extends State<pa_2nd_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_2nd()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_2nd_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
