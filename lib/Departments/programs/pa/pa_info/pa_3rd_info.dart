import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20Outline/eng_OUTLINE_SEMESTER_WISE/pa_3rd.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20fee/pa_fee.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa_timetable_SEMESTER_WISE/pa_3rd_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class pa_3rd_info extends StatefulWidget {
  const pa_3rd_info({Key? key}) : super(key: key);

  @override
  _pa_3rd_infoState createState() => _pa_3rd_infoState();
}

class _pa_3rd_infoState extends State<pa_3rd_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_3rd()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_3rd_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
