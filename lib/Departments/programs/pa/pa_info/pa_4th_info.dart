import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20Outline/eng_OUTLINE_SEMESTER_WISE/pa_4th.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20fee/pa_fee.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa_timetable_SEMESTER_WISE/pa_4th_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class pa_4th_info extends StatefulWidget {
  const pa_4th_info({Key? key}) : super(key: key);

  @override
  _pa_4th_infoState createState() => _pa_4th_infoState();
}

class _pa_4th_infoState extends State<pa_4th_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_4th()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_4th_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
