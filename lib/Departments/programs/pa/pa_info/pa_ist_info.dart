import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20Outline/eng_OUTLINE_SEMESTER_WISE/pa_1st.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa%20fee/pa_fee.dart';
import 'package:bzu_lodhran_off/Departments/programs/pa/pa_timetable_SEMESTER_WISE/pa_1st_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class pa_1st_info extends StatefulWidget {
  const pa_1st_info({Key? key}) : super(key: key);

  @override
  _pa_1st_infoState createState() => _pa_1st_infoState();
}

class _pa_1st_infoState extends State<pa_1st_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_1st()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => pa_1st_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
