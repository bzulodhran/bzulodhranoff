...
class pa_7th extends StatefulWidget {
  const pa_7th({Key? key}) : super(key: key);

  @override
  _pa_7thState createState() => _pa_7thState();
}

class _pa_7thState extends State<pa_7th> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApii.listAll('pa_7th/');
  }
