...
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_OUTLINE_SEMESTER_WISE/socio_1st.dart';
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_timetable_SEMESTER_WISE/socio_1st_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class socio_1st_info extends StatefulWidget {
  const socio_1st_info({Key? key}) : super(key: key);

  @override
  _socio_1st_infoState createState() => _socio_1st_infoState();
}

class _socio_1st_infoState extends State<socio_1st_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_1st()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_1st_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
