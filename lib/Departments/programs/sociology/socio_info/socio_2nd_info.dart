...
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_OUTLINE_SEMESTER_WISE/socio_2nd.dart';
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_timetable_SEMESTER_WISE/socio_2nd_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class socio_2nd_info extends StatefulWidget {
  const socio_2nd_info({Key? key}) : super(key: key);

  @override
  _socio_2nd_infoState createState() => _socio_2nd_infoState();
}

class _socio_2nd_infoState extends State<socio_2nd_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_2nd()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_2nd_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
