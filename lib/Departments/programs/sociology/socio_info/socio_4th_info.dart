...
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_OUTLINE_SEMESTER_WISE/socio_4th.dart';
import 'package:bzu_lodhran_off/Departments/programs/sociology/socio_timetable_SEMESTER_WISE/socio_4th_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class socio_4th_info extends StatefulWidget {
  const socio_4th_info({Key? key}) : super(key: key);

  @override
  _socio_4th_infoState createState() => _socio_4th_infoState();
}

class _socio_4th_infoState extends State<socio_4th_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_4th()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => socio_4th_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
