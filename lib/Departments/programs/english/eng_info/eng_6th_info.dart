import 'package:bzu_lodhran_off/Departments/programs/english/eng%20Outline/eng_OUTLINE_SEMESTER_WISE/eng_6th.dart';
import 'package:bzu_lodhran_off/Departments/programs/english/eng%20TimeTable/eng_timetable_SEMESTER_WISE/eng_6th_time.dart';
import 'package:bzu_lodhran_off/Departments/programs/english/eng%20fee/eng_result.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class eng_6th_info extends StatefulWidget {
  const eng_6th_info({Key? key}) : super(key: key);

  @override
  _eng_6th_infoState createState() => _eng_6th_infoState();
}

class _eng_6th_infoState extends State<eng_6th_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => eng_6th()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => eng_6th_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
