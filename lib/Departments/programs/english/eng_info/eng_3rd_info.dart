import 'package:bzu_lodhran_off/Departments/programs/english/eng%20Outline/eng_OUTLINE_SEMESTER_WISE/eng_3rd.dart';
import 'package:bzu_lodhran_off/Departments/programs/english/eng%20TimeTable/eng_timetable_SEMESTER_WISE/eng_3rd_time.dart';
import 'package:bzu_lodhran_off/Departments/programs/english/eng%20fee/eng_result.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class eng_3rd_info extends StatefulWidget {
  const eng_3rd_info({Key? key}) : super(key: key);

  @override
  _eng_3rd_infoState createState() => _eng_3rd_infoState();
}

class _eng_3rd_infoState extends State<eng_3rd_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => eng_3rd()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => eng_3rd_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
