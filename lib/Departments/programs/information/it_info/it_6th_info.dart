import 'package:bzu_lodhran_off/Departments/programs/information/IT%20Outline/IT_OUTLINE_SEMESTER_WISE/it_6th.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20fee/it_result.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20timetable/IT_timetable_SEMESTER_WISE/it_6th_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class it_6th_info extends StatefulWidget {
  const it_6th_info({Key? key}) : super(key: key);

  @override
  _it_6th_infoState createState() => _it_6th_infoState();
}

class _it_6th_infoState extends State<it_6th_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_6th()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_6th_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
