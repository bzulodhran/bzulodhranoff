import 'package:bzu_lodhran_off/Departments/programs/information/IT%20Outline/IT_OUTLINE_SEMESTER_WISE/it_2nd.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20fee/it_result.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20timetable/IT_timetable_SEMESTER_WISE/it_2nd_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class it_2nd_info extends StatefulWidget {
  const it_2nd_info({Key? key}) : super(key: key);

  @override
  _it_2nd_infoState createState() => _it_2nd_infoState();
}

class _it_2nd_infoState extends State<it_2nd_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_2nd()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_2nd_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
