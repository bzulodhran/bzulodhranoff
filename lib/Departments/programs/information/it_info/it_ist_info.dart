import 'package:bzu_lodhran_off/Departments/programs/information/IT%20Outline/IT_OUTLINE_SEMESTER_WISE/it_1st.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20fee/it_result.dart';
import 'package:bzu_lodhran_off/Departments/programs/information/IT%20timetable/IT_timetable_SEMESTER_WISE/it_1st_time.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
class it_1st_info extends StatefulWidget {
  const it_1st_info({Key? key}) : super(key: key);

  @override
  _it_1st_infoState createState() => _it_1st_infoState();
}

class _it_1st_infoState extends State<it_1st_info> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_1st()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) => it_1st_time()),
                  );
                },
                splashColor: Colors.blue,
                child: Center(
