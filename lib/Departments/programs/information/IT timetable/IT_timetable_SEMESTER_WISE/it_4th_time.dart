...
class it_4th_time extends StatefulWidget {
  const it_4th_time({Key? key}) : super(key: key);

  @override
  _it_4th_timeState createState() => _it_4th_timeState();
}

class _it_4th_timeState extends State<it_4th_time> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApii.listAll('it_4th_time/');
  }
