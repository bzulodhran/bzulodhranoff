...
class it_7th_time extends StatefulWidget {
  const it_7th_time({Key? key}) : super(key: key);

  @override
  _it_7th_timeState createState() => _it_7th_timeState();
}

class _it_7th_timeState extends State<it_7th_time> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApii.listAll('it_7th_time/');
  }
