...
class it_2nd_time extends StatefulWidget {
  const it_2nd_time({Key? key}) : super(key: key);

  @override
  _it_2nd_timeState createState() => _it_2nd_timeState();
}

class _it_2nd_timeState extends State<it_2nd_time> {
  ...
  void initState() {
    ...
    futureFiles = FirebaseApii.listAll('it_2nd_time/');
  }
