...
class _examinationState extends State<examination> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: new AppBar(
        title: Text("Examination Incharge"),
            ...
            child: Center(
              child: Column(
                children: [
                  ...
                  Text("EXAMINATION INCHARGE(Sociology & BSPA)",
                      style: GoogleFonts.fredokaOne(
                    ...
                    child: Center(
                      child: Column(
                        children: [
                          ...
                          Text("EXAMMINATION INCHARGE(IT)",
                              style: GoogleFonts.fredokaOne(
                                  fontSize: 10, color: Colors.indigo[900])),
                          Text("Lecturer(IT)",
                              style: GoogleFonts.fredokaOne(
                                  fontSize: 8, color: Colors.indigo[900])),
                          Text("BZU SUB CAMPUSE LODHARAN",
                              style: GoogleFonts.fredokaOne(
