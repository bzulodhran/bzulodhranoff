...
class pa_fee_up extends StatefulWidget {
  const pa_fee_up({Key? key}) : super(key: key);

  @override
  _pa_fee_upState createState() => _pa_fee_upState();
}

class _pa_fee_upState extends State<pa_fee_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'PA_FEE/$fileName';
