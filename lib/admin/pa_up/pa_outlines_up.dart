...
class pa_outlines_up extends StatefulWidget {
  const pa_outlines_up({Key? key}) : super(key: key);

  @override
  _pa_outlines_upState createState() => _pa_outlines_upState();
}

class _pa_outlines_upState extends State<pa_outlines_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'PA_OUTLINE/$fileName';
