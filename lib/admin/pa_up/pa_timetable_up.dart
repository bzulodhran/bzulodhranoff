...
class pa_timetable_up extends StatefulWidget {
  const pa_timetable_up({Key? key}) : super(key: key);

  @override
  _pa_timetable_upState createState() => _pa_timetable_upState();
}

class _pa_timetable_upState extends State<pa_timetable_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'PA_TIMETABLE/$fileName';
