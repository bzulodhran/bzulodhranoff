import 'package:bzu_lodhran_off/admin/it_up/it_outline/it_5th_outline_up.dart';
import 'package:bzu_lodhran_off/admin/it_up/it_timetable/it_5th_time_up.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import '../it_fee_up.dart';

class it_5th_up extends StatefulWidget {
  const it_5th_up({Key? key}) : super(key: key);

  @override
  _it_5th_upState createState() => _it_5th_upState();
}

class _it_5th_upState extends State<it_5th_up> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        backgroundColor: Colors.indigo,
        title: Text("IT 5th UPLOADS"),
      ),
      body: Center(
        child: Column(
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_5th_outline_up()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_5th_time_up()),
                  );
                },
                splashColor: Colors.blue[500],
                child: Center(
