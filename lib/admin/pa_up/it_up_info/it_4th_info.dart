import 'package:bzu_lodhran_off/admin/it_up/it_outline/it_4th_outline_up.dart';
import 'package:bzu_lodhran_off/admin/it_up/it_timetable/it_4th_time_up.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import '../it_fee_up.dart';

class it_4th_up extends StatefulWidget {
  const it_4th_up({Key? key}) : super(key: key);

  @override
  _it_4th_upState createState() => _it_4th_upState();
}

class _it_4th_upState extends State<it_4th_up> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_4th_outline_up()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_4th_time_up()),
                  );
                },
                splashColor: Colors.blue[500],
                child: Center(
