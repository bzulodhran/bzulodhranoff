...
class eng_fee_up extends StatefulWidget {
  const eng_fee_up({Key? key}) : super(key: key);

  @override
  _eng_fee_upState createState() => _eng_fee_upState();
}

class _eng_fee_upState extends State<eng_fee_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'ENG_FEE/$fileName';
