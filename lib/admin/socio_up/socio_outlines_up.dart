...
class socio_outlines_up extends StatefulWidget {
  const socio_outlines_up({Key? key}) : super(key: key);

  @override
  _socio_outlines_upState createState() => _socio_outlines_upState();
}

class _socio_outlines_upState extends State<socio_outlines_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'SOCIO_OUTLINE/$fileName';
