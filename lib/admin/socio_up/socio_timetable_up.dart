...
class socio_timetable_up extends StatefulWidget {
  const socio_timetable_up({Key? key}) : super(key: key);

  @override
  _socio_timetable_upState createState() => _socio_timetable_upState();
}

class _socio_timetable_upState extends State<socio_timetable_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'SOCIO_TIMETABLE/$fileName';
