...
class socio_fee_up extends StatefulWidget {
  const socio_fee_up({Key? key}) : super(key: key);

  @override
  _socio_fee_upState createState() => _socio_fee_upState();
}

class _socio_fee_upState extends State<socio_fee_up> {
  UploadTask? task;
  File? file;
  ...
  Future uploadFile() async {
    ...
    final destination = 'SOCIO_FEE/$fileName';
