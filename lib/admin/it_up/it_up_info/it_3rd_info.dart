import 'package:bzu_lodhran_off/admin/it_up/it_outline/it_3rd_outline_up.dart';
import 'package:bzu_lodhran_off/admin/it_up/it_timetable/it_3rd_time_up.dart';
import 'package:flutter/material.dart';
import 'package:flutter/cupertino.dart';
import '../it_fee_up.dart';


class it_3rd_up extends StatefulWidget {
  const it_3rd_up({Key? key}) : super(key: key);

  @override
  _it_3rd_upState createState() => _it_3rd_upState();
}

class _it_3rd_upState extends State<it_3rd_up> {
  @override
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_3rd_outline_up()),
                  );
                },
            ...
            Card(
              ...
              child: InkWell(
                onTap: (){
                  Navigator.push(
                    context,
                    MaterialPageRoute(builder: (context) =>it_3rd_time_up()),
                  );
                },
                splashColor: Colors.blue[500],
                child: Center(
